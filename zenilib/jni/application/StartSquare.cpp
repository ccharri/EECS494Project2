...
Square_Start::Square_Start(Room* room_, const Zeni::Point2f position_, const Zeni::Vector2f size_) : Square(room_, position_, size_, true)
{
    ...
    Material hole_mat("ceiling_hole");
	hole = Quadrilateral<Vertex2f_Texture>(ul, ll, lr, ur);
	hole.fax_Material(&hole_mat);
...
void Square_Start::render(Player* player) const
{
